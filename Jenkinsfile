pipeline {
    ...
    environment {
        ...
        FRONTEND_REPO = '113892881104.dkr.ecr.us-east-2.amazonaws.com/devops-challenge-frontend'
        BACKEND_REPO  = '113892881104.dkr.ecr.us-east-2.amazonaws.com/devops-challenge-backend'
    }
